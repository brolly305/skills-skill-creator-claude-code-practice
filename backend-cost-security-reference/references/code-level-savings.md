...
## Contents
- Bundle Size Optimization (tree-shaking, dynamic imports, bundle analysis)
- Image Optimization Pipeline (WebP/AVIF, Sharp pipeline, Next.js Image)
- Database Query Cost (expensive query detection, indexing, N+1 prevention, materialized views)
- Caching ROI (when it pays off, TTL guidelines)
- Memory Leak Detection (common patterns, detection)
- Compression (response, storage, static assets)
