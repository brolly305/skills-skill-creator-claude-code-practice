...
|----|----------|----------|------------|
| A | A2P 10DLC brand + campaign registration | 10d (carrier wait) | — |
| B | Email domain auth (SPF / DKIM / DMARC) | 1d | — |
| C | Email domain warming | 14d | B |
| D | Tag dictionary + custom fields + pipeline stages | 1d | — |
| E | Write all SMS + email copy | 3d | D |
| F | Creative assets (Canva / Higgsfield) | 2d | — |
| G | Calendar setup + booking links | 1d | — |
