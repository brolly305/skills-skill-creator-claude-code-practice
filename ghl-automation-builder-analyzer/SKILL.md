...
- `references/ohana-full-system-build.md`: Full 10-layer AI and automation system (sources, capture, AI response, scoring, walkthroughs, CRM, job lifecycle, integrations, reporting, productizing) adapted to Ohana as the pilot, with workflows W01-W13, the Conversation AI bot prompt, and a go-live checklist. Use it as the template when a client asks for an end-to-end GHL system
